 ...
 */
export const createTable = pgTableCreator((name) => `book-reader_${name}`);
...
export const products = createTable(
  "product",
  {
    ...
    imageUrl: varchar("imageUrl", { length: 1023 }),
  ...
  (product) => ({
    userIdIdx: index("product_userId_idx").on(product.userId),
  }),
);
